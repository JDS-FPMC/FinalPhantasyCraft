...
public class Esper extends RPGClass {
  ...
  public Esper() {
    super("esper", createIconMeta(), 10, "race", "UnAwakened");
  ...
  private static ItemStack createIconMeta() {
    ...
    meta.setDisplayName(ChatColor.RED + "" + ChatColor.BOLD + " The Spiritual Aspect - The Espers ");
    meta.setLore(new ArrayList<String>() {{
      ...
      add(ChatColor.GRAY + "     - Allies gain all available buffs");
      add(ChatColor.GRAY + "     - Increase affected Allies health");
    }});
